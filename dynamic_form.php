...
<body>
    ...
    <p><?php echo htmlspecialchars($display['please_answer_questions']); ?></p>
    ...
    <h1>Vurdering av skattemessig bosted i Norge</h1>
    <p>Vennligst svar på følgende spørsmål for å fastsette status for skattemessig bosted.</p>
    
    <form action="dynamic_form.php?case_id=<?php echo $case_id; ?>" method="POST">
        <div class="form-section">
            <div class="form-group">
                <label>1. Har personen tatt fast opphold i utlandet?</label>
                <div class="radio-option">
                    <input type="radio" id="stayPermanentYes" name="stayPermanent" value="yes" required> 
                    <label for="stayPermanentYes">Ja</label>
                </div>
                <div class="radio-option">
                    <input type="radio" id="stayPermanentNo" name="stayPermanent" value="no"> 
                    <label for="stayPermanentNo">Nei</label>
                </div>
            </div>
        </div>
        ...
        <div id="permanentStaySection" class="form-section hidden">
            <div class="form-group">
                <label>2. Har personen vært skattemessig bosatt i Norge i mer enn 10 år før utflytting?</label>
                <div class="radio-option">
                    <input type="radio" id="taxResidentA10Yes" name="taxResidentA10" value="yes"> 
                    <label for="taxResidentA10Yes">Ja</label>
                </div>
                <div class="radio-option">
                    <input type="radio" id="taxResidentA10No" name="taxResidentA10" value="no"> 
                    <label for="taxResidentA10No">Nei</label>
                </div>
            </div>
            
            <div class="form-group">
                <label>3. Har personen oppholdt seg i Norge i mer enn 61 dager i inntektsåret?</label>
                <div class="radio-option">
                    <input type="radio" id="stayA61Yes" name="stayA61" value="yes"> 
                    <label for="stayA61Yes">Ja</label>
                </div>
                <div class="radio-option">
                    <input type="radio" id="stayA61No" name="stayA61" value="no"> 
                    <label for="stayA61No">Nei</label>
                </div>
            </div>
            
            <div id="homeAccessSection" class="form-group hidden">
                <label>4. Har personen eller nære familiemedlemmer hatt tilgang til bolig i Norge?</label>
                <div class="radio-option">
                    <input type="radio" id="homeAccessAYes" name="homeAccessA" value="yes"> 
                    <label for="homeAccessAYes">Ja</label>
                </div>
                <div class="radio-option">
                    <input type="radio" id="homeAccessANo" name="homeAccessA" value="no"> 
                    <label for="homeAccessANo">Nei</label>
                </div>
            </div>
            
            <div id="threeYearSection" class="form-group hidden">
                <label>5. For hvert av de tre årene etter utflytting, har personen oppholdt seg i Norge i mer enn 61 dager ELLER hatt tilgang til bolig i Norge i NOEN av disse årene?</label>
                <div class="radio-option">
                    <input type="radio" id="threeYearRuleYes" name="threeYearRule" value="yes"> 
                    <label for="threeYearRuleYes">Ja (i minst ett av de tre årene)</label>
                </div>
                <div class="radio-option">
                    <input type="radio" id="threeYearRuleNo" name="threeYearRule" value="no"> 
                    <label for="threeYearRuleNo">Nei (oppfyller betingelsene for ALLE tre år)</label>
                </div>
            </div>
        </div>
        ...
        <div id="taxResidentBSection" class="form-section hidden">
            <div class="form-group">
                <label>Er personen skattemessig bosatt i det andre landet?</label>
                <div class="radio-option">
                    <input type="radio" id="residentTaxBYes" name="residentTaxB" value="yes"> 
                    <label for="residentTaxBYes">Ja</label>
                </div>
                <div class="radio-option">
                    <input type="radio" id="residentTaxBNo" name="residentTaxB" value="no"> 
                    <label for="residentTaxBNo">Nei</label>
                </div>
            </div>
        </div>
        
        <button type="submit">Send inn vurdering</button>
    </form>
        <?php } ?>
